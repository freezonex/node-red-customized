...
$deploy-button-color: #000000;
$deploy-button-color-active: #161616;
$deploy-button-color-disabled: #8D8D8D;
$deploy-button-background: #B2ED1D;
$deploy-button-background-hover: #9BC348;
$deploy-button-background-active: #647B32;
$deploy-button-background-disabled: #C6C6C6;
$deploy-button-background-disabled-hover: #686868;


$header-background: #F4F4F4;
$header-button-background-active: #666;
$header-accent: #fff;
$header-menu-color: #323232;
$header-menu-color-disabled: #666;
$header-menu-heading-color: #000;
$header-menu-sublabel-color: #5c5a5a;
$header-menu-background: #fff;
$header-menu-item-hover: #7e7e7e;
